...
const macFile = "https://github.com/shenfang055-gif/zaine/releases/download/v0.1.3/zai-ne-0.1.3-macOS-Apple-Silicon.dmg";
const windowsFile = "https://github.com/shenfang055-gif/zaine/releases/download/v0.1.3/zai-ne-0.1.3-Windows-x64.exe";
...
export default function DownloadPage() {
  return <main className="download-page">
    ...
    <section className="download-final" id="download"><div><span>04 / 现在开始</span><h2>急急急？<br/>先别急，先记录此刻。</h2><p>下载在呢 ZAI NE 公开测试版。无需注册，数据默认只保存在这台电脑。</p></div><div className="final-download-list"><a href={macFile} download><span><strong>macOS · Apple Silicon</strong><small>0.1.3 · DMG</small></span><b>下载 ↓</b></a><a href={windowsFile} download><span><strong>Windows 10 / 11 · x64</strong><small>0.1.3 · EXE</small></span><b>下载 ↓</b></a><div className="release-note"><strong>macOS 首次打开</strong><p>打开 DMG 后把应用拖入“应用程序”，再在访达中右键应用并选择“打开”。测试版尚未经过 Apple 公证，部分系统仍可能显示安全提醒。</p></div></div></section>
