...
const macFile = "https://github.com/shenfang055-gif/zaine/releases/download/v0.1.0/zai-ne-0.1.0-macOS-Apple-Silicon.zip";
const windowsFile = "https://github.com/shenfang055-gif/zaine/releases/download/v0.1.0/zai-ne-0.1.0-Windows-x64.exe";
...
export default function DownloadPage() {
  return <main className="download-page">
    ...
    <section className="download-hero" id="top">
      <div className="download-hero-copy"><div className="download-eyebrow"><span>个人生活记录客户端</span><em>PUBLIC BETA · 0.1.0</em></div><h1>安排生活，<br/><i>也把此刻留下来。</i></h1><p>待办、日历、随手记和知识库，安静地住在你的电脑里。急急急？先别急，先记录此刻。</p><div className="download-actions"><a className="download-main" href={macFile} download><span><strong>下载 macOS 版</strong><small>Apple Silicon · ZIP · 136 MB</small></span><b>↓</b></a><a className="download-main windows" href={windowsFile} download><span><strong>下载 Windows 版</strong><small>Windows 10 / 11 · x64 · 111 MB</small></span><b>↓</b></a></div><div className="download-promises"><span>无需注册</span><span>数据保存在本机</span><span>每个人互相独立</span></div></div>
    ...
    <section className="download-final" id="download"><div><span>04 / 现在开始</span><h2>急急急？<br/>先别急，先记录此刻。</h2><p>下载在呢 ZAI NE 公开测试版。无需注册，数据默认只保存在这台电脑。</p></div><div className="final-download-list"><a href={macFile} download><span><strong>macOS · Apple Silicon</strong><small>0.1.0 · ZIP · 136 MB</small></span><b>下载 ↓</b></a><a href={windowsFile} download><span><strong>Windows 10 / 11 · x64</strong><small>0.1.0 · EXE · 111 MB</small></span><b>下载 ↓</b></a><div className="release-note"><strong>公开测试版安装提醒</strong><p>当前安装包尚未进行 Apple 与 Microsoft 商店签名，首次打开时系统可能显示安全提醒。</p><details><summary>查看文件校验值</summary><code>macOS · a7c6bc7f636739d1d57d38988a5de49f9d16c42903a306835ad6a770e951f860</code><code>Windows · c32b84c1f37cf512ae2ec1821821cd7750b6d7cb411819dcfbab94a28ead6696</code></details></div></div></section>
